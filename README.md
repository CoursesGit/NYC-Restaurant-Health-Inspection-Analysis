...
* Remove invalid placeholder dates
...
* Find cuisines with higher average scores or higher critical violation rates
* Identify cuisines with higher proportions of critical violations
...
* Identify where targeted inspections or public health campaigns could focus
* Identify cuisines and areas where food safety training may help
* Highlight possible policy focus areas based on risk patterns
...
The cleaning process was focused on the fields needed for analysis and dashboard development.
...
* Cuisines with higher average scores or higher critical violation rates
...
The Power BI dashboard focuses on restaurant inspection risk, geographic patterns, time trends, and decision-support recommendations.
...
* Certain cuisine groups showed higher critical violation rates, which may indicate where targeted food safety training or further review could be useful.
...
* Prioritize neighborhoods with higher critical violation rates for further review.
* Identify cuisine groups that may benefit from targeted food safety training.
* Monitor score trends and critical violation rates over time.
* Compare borough and neighborhood-level risk patterns more clearly.
* Review areas or cuisine groups that repeatedly show higher-risk inspection patterns.
...
This project demonstrates junior data analyst skills, including SQL data cleaning, exploratory analysis, Power BI dashboard design, and turning analysis results into decision-support recommendations.
